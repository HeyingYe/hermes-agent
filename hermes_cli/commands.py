...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("jarvis", "Jarvis P0 local MVP: route chat, preview brief, summarize docs",
               "Tools & Skills", args_hint="[route|brief|summarize]", cli_only=True,
               subcommands=("route", "brief", "summarize")),
